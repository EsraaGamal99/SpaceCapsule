...
class AppTextStyles {
  ...
  static TextStyle fontLightGrey30W700   = TextStyle(color: AppColors.primaryLightGreyColor, fontSize: 30.sp, fontWeight: FontWeight.w700, fontFamily: poppinsFontFamily);
